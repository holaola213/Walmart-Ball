...
export function FairTradeSlide({ data, direction, trade, rank }: Props) {
  return (
    <SlideLayout accentColor={SLIDE_COLORS.trades} direction={direction} pattern="grid">
      ...
      >
        #{rank} closest post-trade result
      </motion.h2>
      ...
      >
        ...
        <div className="px-2 text-center">
          ...
          <p
            ...
            style={{ color: "#F4C542", textShadow: "0 0 24px rgba(244, 197, 66, 0.22)" }}
          >

...
export default function Home() {
  ...
  // Transition from loading to slides when data is ready
  if (view === "loading" && status === "success" && data) {
    setView("slides");
  }

  if (view === "loading" && status === "error") {
    return (
      <ErrorScreen
  ...
  if (view === "personal" && data && selectedTeamId !== null) {
    ...
    >
      ...
      >
        <motion.p
          ...
          className="text-white/30 text-xs font-stat uppercase tracking-[0.5em] mb-6"
        >
          Fantasy Basketball
        </motion.p>
        ...
        <motion.h1
          ...
          className="font-display text-7xl md:text-9xl lg:text-[10rem] text-white leading-[0.85] mb-4"
          style={{
        ...
        <motion.p
          ...
          className="text-violet-400/70 text-sm tracking-wider mb-14"
        >
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center gap-1.5 mb-3">
              ...
              <span className="text-green-400/80 text-[9px] font-stat tracking-[0.2em] uppercase">
                Ready
              </span>
            </div>
            ...
            <p className="relative font-display text-xl text-white mb-1">
              Regular Season
            </p>
            <p className="relative text-white/30 text-[10px] font-stat tracking-widest">
              VIEW WRAPPED
            </p>
          </motion.button>
          ...
          >
            ...
            <div className="flex items-center justify-center gap-1.5 mb-3">
              ...
              <span className="text-white/20 text-[9px] font-stat tracking-[0.2em] uppercase">
                Locked
              </span>
            </div>
            ...
            <p className="font-display text-xl text-white/15 mb-2">
              Playoffs
            </p>
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="text-center">
                ...
                <p className="text-white/10 text-[8px] font-stat tracking-wider">DAY</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white/10 text-[8px] font-stat tracking-wider">HR</p>
              </div>
              <span className="text-white/10 text-[10px] font-stat -mt-2">:</span>
              <div className="text-center">
                <p className="font-stat text-sm text-white/25 leading-none">{countdown.minutes}</p>
                <p className="text-white/10 text-[8px] font-stat tracking-wider">MIN</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
      ...
      {showPasswordModal && (
        ...
        >
          ...
          >
            <p className="font-stat text-[10px] text-violet-400/50 tracking-[0.3em] uppercase mb-4">
              Enter Password
            </p>
            ...
            <div className="flex gap-3 mt-5">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-white/30 text-xs font-stat tracking-wider hover:text-white/50 transition-colors"
                style={{
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-white text-xs font-stat tracking-wider hover:opacity-80 transition-opacity"
                style={{
